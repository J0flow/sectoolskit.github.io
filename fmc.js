...
async function main() {
    ...
    // Demander à l'utilisateur d'entrer le payload DHCP
    ...
    // Demander les autres informations à l'utilisateur
    ...
    // Demander s'il y a d'autres billets
    const ticketList = [];
    while (true) {
...
IoC / évidences :`;
    ...
    // Afficher les résultats de l'analyse des IPs
    results.forEach(result => console.log(result));

    // Nombre d'IP analysées
